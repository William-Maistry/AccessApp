    ...
    private fun setupListeners() {
        ...
        binding.btnScanId.setOnClickListener {
            val args = Bundle().apply {
                ...
                putString("requestKey", "lost_id_scan")
            }
        ...
        binding.btnScanLicense.setOnClickListener {
            val args = Bundle().apply {
                putBoolean("returnResult", true)
                putString("requestKey", "lost_license_scan")
            }
            findNavController().navigate(R.id.scannerFragment, args)
        }
        ...
        viewLifecycleOwner.lifecycleScope.launch {
            ...
            try {
                ...
                if (isMatch) {
                    ...
                    binding.btnConfirmRecovery.visibility = View.VISIBLE
                    ...
                    binding.btnConfirmRecovery.visibility = View.GONE
                }
            ...
            try {
                ...
                MaterialAlertDialogBuilder(requireContext())
                    ...
                    .setPositiveButton("OK") { _, _ ->
                        if (isPassenger) {
                            // Remove failed passenger (who was added in completeAttendanceSession)

...
public final class FragmentSettingsBinding implements ViewBinding {
  ...
  private FragmentSettingsBinding(@NonNull ConstraintLayout rootView,
      @NonNull MaterialButton btnHome, @NonNull TextView title,
      @NonNull MaterialSwitch torchSwitch) {
  ...
  public static FragmentSettingsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.torch_switch;
      MaterialSwitch torchSwitch = ViewBindings.findChildViewById(rootView, id);
      if (torchSwitch == null) {
        break missingId;
      }

      return new FragmentSettingsBinding((ConstraintLayout) rootView, btnHome, title, torchSwitch);
    }
